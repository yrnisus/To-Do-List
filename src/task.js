...
function newTaskForm() {
    ...
    newTaskFormWrapper.innerHTML = '<form><label for="title">Title:</label><input type="text" id="title" name="title"><label for="description">Description</label><textarea name="description" id="description" rows="3"></textarea><label for="date">Date</label><input type="date" onfocus="this.showPicker()" id="date" name="date"><label for="urgency">Urgency</label><select name="urgency" id="urgencyt"><option value="">--Please select an option--</option><option value="high">High</option><option value="medium">Medium</option><option value="low">Low</option></select><div class="form-buttons"><button type="submit" form="form1" value="Submit">Submit</button><button id="cancel-btn" type="submit" form="form1" value="Submit">Cancel</button><div></form>';
...
export { Task, populateTaskList, addTask, taskArray };